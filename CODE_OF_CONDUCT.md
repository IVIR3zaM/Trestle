...
Trestle's contribution model is built around arguing with written-down decisions —
[`decisions.md`](plan/v0.1.0/decisions.md) exists to be disagreed with, and
[`CONTRIBUTING.md`](CONTRIBUTING.md) actively invites it.

Disagreeing strongly with a decision, a design, or a piece of code is welcome and
expected. Disagreeing with a *person* is not the same thing, and the difference is
usually visible in whether the sentence has a "you" in it. Keep the argument on the
work.
...
to the project maintainers through a
[GitHub issue](https://github.com/IVIR3zaM/Trestle/issues) or, where privacy is
warranted, directly to the repository owner via their GitHub profile.
